...
public class ConcursoBase  implements Concurso{
    ...
    public ConcursoBase(String nombre, LocalDate fechaInicioInscripcion, LocalDate fechaFinInscripcion, InscripcionDAO inscripcionDAO) {
    ...
    public ConcursoBase(String id, String nombre, LocalDate fechaInicioInscripcion, LocalDate fechaFinInscripcion) {
    ...
    public String baseMensaje(){
        return "Haz sido inscrito en el concurso :" + this.id +" - " +this.nombre;
    }
    ...
    public boolean equals(Object o) {
        ...
        ConcursoBase concursoBase = (ConcursoBase) o;
        return Objects.equals(nombre, concursoBase.nombre) && Objects.equals(fechaInicioInscripcion, concursoBase.fechaInicioInscripcion) && Objects.equals(fechaFinInscripcion, concursoBase.fechaFinInscripcion);
    }
